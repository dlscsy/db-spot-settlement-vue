<template>
  <el-collapse v-model="activeElCollapseName">
    <el-collapse-item name="elCollapseItem1">
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="8">
          ...
          >
            <el-select
              :value="value['exSelfImpl']"
              @input="handleInput($event, 'exSelfImpl')"
              style="width:100%;"
              clearable
            >
              <el-option v-for="o in exCheck" :key="o.value" :label="o.label" :value="o.value"></el-option>
    ...
    <el-collapse-item name="elCollapseItem2">
      ...
      <el-row :gutter="10">
        <el-col :span="8">
          <el-form-item label="年度用电规模" :rules="rules.NumPot4" prop="eleScale">
            <el-input
              :value="value['eleScale']"
              @input="handleInput($event, 'eleScale')"
              placeholder="请输入年度用电规模"
              clearable
            />
          </el-form-item>
        </el-col>
...
export default {
  ...
  mounted () {
    this.init();
    this.isShow(this.value.category);
  },
  methods: {
    init () {
    ...
    isShow (val) {
      ...
      this.showExSelfImpl = val == "4" || val == "5";
    },
    handleInput (val, key) {
